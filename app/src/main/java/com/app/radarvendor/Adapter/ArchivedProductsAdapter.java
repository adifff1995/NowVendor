...
public class ArchivedProductsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List<Product> productList;
    private RvProductsItemBinding binding;
    private OnItemSelect itemClick;

    public ArchivedProductsAdapter(Context context, List<Product> productList, OnItemSelect itemClick) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        myViewHolder.binding.tvMore.setVisibility(View.VISIBLE);
        myViewHolder.binding.tvRating.setVisibility(View.GONE);
        myViewHolder.binding.getRoot().setOnClickListener(view -> itemClick.onProductClicked(position));
        myViewHolder.binding.tvMore.setOnClickListener(view -> itemClick.onMenuClicked(position));
