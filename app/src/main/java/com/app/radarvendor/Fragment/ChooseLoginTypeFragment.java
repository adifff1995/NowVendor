...
import com.app.radarvendor.databinding.FragmentChooseLoginTypeBinding;
import com.orhanobut.hawk.Hawk;

/**
 * A simple {@link Fragment} subclass.
 * Use the {@link ChooseLoginTypeFragment#newInstance} factory method to
...
public class ChooseLoginTypeFragment extends Fragment {
     ...
     * @return A new instance of fragment ChooseLoginTypeFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ChooseLoginTypeFragment newInstance(String param1, String param2) {
        ChooseLoginTypeFragment fragment = new ChooseLoginTypeFragment();
    ...
    private void setUpAction() {
        ...
        binding.btnContinue.setOnClickListener(view -> {
            if (flag == 0)
                ...
                FragmentUtil.addFragmentWithBackStack(activity, new LoginDeliveryFragment(), R.id.boarding, "");
