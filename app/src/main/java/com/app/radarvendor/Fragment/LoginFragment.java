...
//        params.put("fcm", "1");
        ...
        Call<ResultAPIModel<Vendor>> call = GlobalMethods.getApiInterface().login(params);
            ...
            public void onResponse(Call<ResultAPIModel<Vendor>> call, Response<ResultAPIModel<Vendor>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (result.success == Constant.Status_successful) {
                        ...
                        Hawk.put(Constant.accountType, result.data.getType());
                        if (result.data.getVerified()) {
                            ...
                            goToHome(result.data.getType());
                        } else {
                            GlobalMethods.showSuccessToast(activity, result.message);
                            FragmentUtil.addFragmentWithBackStack(activity, VerifyCodeFragment.newInstance(phoneCode + mobile, ""), R.id.boarding, "");
                        }
