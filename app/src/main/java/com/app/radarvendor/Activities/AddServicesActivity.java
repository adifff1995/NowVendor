...
public class AddServicesActivity extends AppCompatActivity {
    ...
    private Context context = AddServicesActivity.this;
    ...
    private void setUpActivity() {
        gson = new Gson();
        binding.tool.tvMainTitle.setText(getString(R.string.new_service));
            ...
            if (GlobalMethods.setEditTextEmptyError(context, binding.edName) &&
                ...
                if (image != null) {
                    if (serviceTime != -1) {
                        ...
                        addService(binding.edName.getText().toString(),
                        ...
                        GlobalMethods.showWarningToast(AddServicesActivity.this, "الرجاء اختيار مدة الخدمة");


                } else
                    GlobalMethods.showWarningToast(AddServicesActivity.this, "الرجاء اضافة صور للخدمة");
    ...
    public void addService(String name, String service_time, String price, String description,
        ...
        Call<ResultAPIModel> call = GlobalMethods.getApiInterface().addService(GlobalMethods.getHeaders(),
                nameRequestBody, serviceTimeRequestBody,
        ...
        call.enqueue(new Callback<ResultAPIModel>() {
            ...
            public void onResponse(Call<ResultAPIModel> call, Response<ResultAPIModel> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (result.success == Constant.Status_successful) {
                        GlobalMethods.showSuccessToast(AddServicesActivity.this, result.message);
                        finish();
                    } else {
                        GlobalMethods.showErrorToast(AddServicesActivity.this, result.message);
                    }
                    ...
                    try {
                        ...
                        GlobalMethods.showErrorToast(AddServicesActivity.this, errorModel.message);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
            ...
            public void onFailure(Call<ResultAPIModel> call, Throwable t) {
                ...
                if (t instanceof UnknownHostException || t instanceof NoRouteToHostException) {
                    NoConnectionDialog.with(AddServicesActivity.this);
                }
            }
        });
